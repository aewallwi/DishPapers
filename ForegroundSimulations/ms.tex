...
\begin{figure}[htb]
  ...
  \caption{{\bf 19-element HERA layout used in this study, a subset of the full proposed 350-element layout. It is located in the South African Karoo Radio Astronomy Reserve. Each dish is 14~m across. The relative physical scale is illustrated by the group of people in this picture.}}
  \label{fig:HERA-19}
\end{figure}
...
{\bf Equations~\ref{eqn:obsvis} and \ref{eqn:delay-transform} define} the interplay between foregrounds, {\bf the} antenna power pattern, and the mapping between geometric phases of baselines and delays. We discuss the spillover of foreground power beyond the horizon delay limits caused by the chromatic nature of the antenna power pattern.
