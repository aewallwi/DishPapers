...
\begin{figure}
\centering
\includegraphics[width=1.0\linewidth]{plots1/delayspectrum.png}
...
\begin{figure}
\centering
\includegraphics[totalheight=0.6\linewidth]{plots1/delayspectrum_feed.png}
...
%\begin{figure}[ht!]
%\centering
%\includegraphics[width=1.0\linewidth]{plots1/delayspectrum_height.png}
