...
an antenna's frequency performance has on the viability of
...
In particular, it provides straightforward relationship
...
made by a VNA and the extent of sidelobes of bright foregrounds in delay space.
...
These reflectometry measurements exhibit spurious structure relative
...
power spectrum at $k_{\parallel} > 0.1$. This study represents a major step toward
qualifying HERA as a power spectrum instrument and highlights as an
important method for characterizing instrumental systematics for future
experiments aiming to detect the 21~cm EoR power spectrum.  
\end{abstract}
