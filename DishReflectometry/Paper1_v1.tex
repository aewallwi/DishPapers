...
\centering
\includegraphics[angle=0, width=\linewidth]{plots/s11_mag_fullband.png}
\end{minipage}
\hspace{0.1cm}
\begin{minipage}[b]{0.5\linewidth}
\centering
\includegraphics[angle=0, width=\linewidth]{plots/s11_ph_fullband.png}
\end{minipage}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{plots/delay_spectrum_100_200_blackman_Harris.png}
...
The delay spectrum of the instrument is the combined response due to the dish and the feed reflections. Any additional reflections also contributes to the measured return loss and thus contributed to the delay spectrum at various delays. Figure \ref{fig:feed_only} shows the delay spectrum of the feed alone while the feed is kept upside down on the ground.  
